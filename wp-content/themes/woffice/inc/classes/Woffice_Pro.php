...
if( ! class_exists( 'Woffice_Pro' ) ) {
    class Woffice_Pro
    {
        ...
        static function api_check_pro_account() {
            ...
            // We call the API
            $raw_response = wp_remote_post('https://hub.alkalab.com/api/pro/check', $request_string);
        ...
        public function woffice_alka_pro_screen_content() {
            ...
            $base_url = "https://hub.alkalab.com/pro/";
            ...
            <div class="wrap woffice-alka-pro">
                ...
                <div class="text-center">
                    <a href="https://hub.alkalab.com/pro" target="_blank" class="button button-primary button-hero">View in a new secure tab</a>
