        ...
        public function filter_theme_fw_ext_backups_demos($demos)
        {
            $demos_array = array(
                'allinone-demo' => array(
                    ...
                    'screenshot' => 'https://hub.alkalab.com/storage/woffice/demos/demo-allinone.png',
                    'preview_link' => 'https://demos.alka-web.com/woffice/allinone/',
                ),
                'business-demo' => array(
                    'title' => __('Business Demo', 'woffice'),
                    'screenshot' => 'https://hub.alkalab.com/storage/woffice/demos/demo-business.png',
                    'preview_link' => 'https://demos.alka-web.com/woffice/business/',
                ),
                'community-demo' => array(
                    'title' => __('Community Demo', 'woffice'),
                    'screenshot' => 'https://hub.alkalab.com/storage/woffice/demos/demo-community.png',
                    'preview_link' => 'https://demos.alka-web.com/woffice/community/',
                ),
                'school-demo' => array(
                    'title' => __('School Demo', 'woffice'),
                    'screenshot' => 'https://hub.alkalab.com/storage/woffice/demos/demo-school.png',
            ...
            if ($enable_hub) {
                ...
                $download_url = 'https://hub.alkalab.com/api/woffice/demos/';
