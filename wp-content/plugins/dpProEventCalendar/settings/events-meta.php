...
function dpProEventCalendar_meta_box_save( $post_id ) {
	...
	if(get_post_type($post_id) == 'pec-events') {
		...
		update_post_meta( $post_id, 'pec_date', wp_kses( $_POST['pec_date_y'] ."-".str_pad($_POST['pec_date_m'], 2, "0", STR_PAD_LEFT)."-".str_pad($_POST['pec_date_d'], 2, "0", STR_PAD_LEFT). " " . $_POST['pec_time_hours'] . ":" . $_POST['pec_time_minutes'] . ":00", $allowed ) );
...
Woocommerce Event Tickets extension</a>.','dpProEventCalendar'); ?></p></div>
    ...
    <div id="pec_new_booking" style="display: none;">
	    ...
	    <div class="misc-pub-section">
            ...
            <button type="button" class="dpProEventCalendar_btn_getBookingEventDate button">
