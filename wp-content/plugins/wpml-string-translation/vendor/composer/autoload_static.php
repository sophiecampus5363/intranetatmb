...
class ComposerStaticInit3dbe46cb8a5af12648a68f5f9cfd19db
{
    ...
    public static $classMap = array (
        ...
        'WPML_ST_JED_Domain' => __DIR__ . '/../..' . '/classes/jed-translations/wpml-st-jed-domain.php',
        'WPML_ST_JED_File_Builder' => __DIR__ . '/../..' . '/classes/jed-translations/wpml-st-jed-file-builder.php',
        'WPML_ST_JED_File_Manager' => __DIR__ . '/../..' . '/classes/jed-translations/wpml-st-jed-file-manager.php',
        'WPML_ST_JED_File_Update_Hooks' => __DIR__ . '/../..' . '/classes/jed-translations/wpml-st-jed-file-update-hooks.php',
        'WPML_ST_JED_Locales_Domains_Mapper' => __DIR__ . '/../..' . '/classes/jed-translations/wpml-st-jed-domains-locales-mapper.php',
        'WPML_ST_JED_String' => __DIR__ . '/../..' . '/classes/jed-translations/wpml-st-jed-string.php',
        'WPML_ST_JED_Strings_Retrieve' => __DIR__ . '/../..' . '/classes/jed-translations/wpml-st-jed-strings-retrieve.php',
        ...
        'WPML_ST_Script_Translations_Hooks' => __DIR__ . '/../..' . '/classes/jed-translations/wpml-st-script-translations-hooks.php',
        'WPML_ST_Script_Translations_Hooks_Factory' => __DIR__ . '/../..' . '/classes/jed-translations/wpml-st-script-translations-hooks-factory.php',
        ...
        'WPML_ST_Translations_File_Scan_Hooks' => __DIR__ . '/../..' . '/classes/translations-file-scan/wpml-st-translations-file-scan-hooks.php',
