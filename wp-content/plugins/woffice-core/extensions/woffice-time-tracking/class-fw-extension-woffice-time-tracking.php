...
class FW_Extension_Woffice_Time_Tracking extends FW_Extension {
    ...
    public function addScript() {
        ...
        wp_enqueue_script( 'woffice-time-tracking-js', woffice_get_extension_uri('time-tracking', 'static/js/woffice-time-tracking.js'));
    ...
    public function export() {
        ...
        foreach ($users as $user) {
            ...
            foreach ($log as $day=>$item) {
                ...
                fputcsv($output, array(__('Tracks:'). ' '. $day));
