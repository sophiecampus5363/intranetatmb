                            ...
                            <div class="form-row wof-col-3">
                                <div class="form-group">
                                    ...
                                    <select id="repeat" v-model="calendarEvent.woffice_event_repeat" @change="updateRepetition($event)">
                                         <option v-for="opt in fieldOptions.woffice_event_repeat.choices" :value="opt"> {{opt}} </option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>{{ fieldOptions.woffice_event_color.label }}</label>
                                    <select id="color" v-model="calendarEvent.woffice_event_color">
                                         <option v-for="opt in fieldOptions.woffice_event_color.choices" :value="opt"> {{opt}} </option>
                                    </select>
                                </div>
                                <div class="form-group">
...
Vue.component('calendar-day', {
    ...
    methods: {
         ...
         * @return {string}
         */
        eventTimeSpan(start, end, visibility) {
            if (start === end) {
    ...
    <div class="calendar-cell-container" :data-after-content="showDate(date)">
        ...
        <template v-if="user_events">
            <div class="wo-date-events">
                <div @click.prevent="dailyView=true" class="event-box font-weight-normal small text-white" 
                ...
                <div class="modal-wrapper">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content event-daily-view text-left">
                      <div class="event-modal-header">
                        <h5 class="modal-title">{{ user_events[0].event_date_display }}</h5>
                      ...
                      <div class="modal-body">
                        <div class="daily-event" 
                            ...
                            <a :href="user_event.post_link" class="event-link">
                                <div class="details">
                                    <h6>{{ user_event.woffice_event_title }}</h6>
                                    <p v-html="eventTimeSpan(user_event.event_time, user_event.event_end_time, user_event.event_visibility)"></p>
                                </div>
...
new Vue({
    ...
    methods: {
        ...
        getType: function(cellDate){
            ...
            var calendarDate = new Date(cellDate);
    ...
    <div id="woffice-calendar" class="woffice-calendar" :class="{'woffice-calendar__widget': isWidget}">
       <div class="container">
            <div class="row mb-5 woffice-calendar__nav">
                ...
                <div class="calendar-actions col-sm-4 text-right">
                    ...
                    <span class="calendar-event-export p-2"
       ...
       <div class="text-center" v-if="exchanger.field_options.user > 0">
